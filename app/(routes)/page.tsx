  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900">
      ...
      <section className="relative w-full h-[60vh] bg-gray-300 flex items-center justify-center">
        {/* <Image src="/better-blyde.jpg" alt="Fashion" layout="fill" objectFit="cover" className="opacity-75" /> */}
        <video
      ...
      <section className="p-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {clothes.map((item) => (
            <div
              key={item.id}
              className="relative overflow-hidden bg-white shadow-lg group"
            >
